...
AEGIS_FIXED_ORIGIN=com.nokia.maemo apt-get -qq --force-yes install wget libxcb-image0 libxcb-keysyms1 libxcb-icccm1 libxcb-aux0 libxcb-event1 libxcb-property1 libxcb-atom1 libxcb-sync0 libxcb-xfixes0 libxcb-randr0 libxcb-render-util0 libxslt1.1
